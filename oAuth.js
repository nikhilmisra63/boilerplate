...
SocialAuthGrantType.prototype.saveToken = function(
  user,
  client,
  scope,
  deviceType,
  ...
  return Promise.all(fns)
    ...
    .spread(function(
      ...
      return promisify(this.model.saveToken, 5).call(
        this.model,
        token,
        client,
        user,
...
LocalAuthGrantType.prototype.saveToken = function(
  user,
  client,
  scope,
  deviceType,
...
RefreshGrantType.prototype.saveToken = function(
  user,
  client,
  scope,
  deviceType,
...
app.oauth = new OAuth2Server({
  ...
  model: require('./model/accessToken/facade'),
